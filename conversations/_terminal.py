...
def load_terminal(conversation_id: str) -> dict[str, list[dict[str, Any]]]:
...
def save_terminal(
    conversation_id: str, transcripts: dict[str, list[dict[str, Any]]],
) -> None:
...
class TerminalWriter:
    ...
    def __init__(self, conversation_id: str) -> None:
        ...
        self._transcripts: dict[str, list[dict[str, Any]]] | None = None
