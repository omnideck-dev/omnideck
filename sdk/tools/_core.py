...
async def get_core_tools() -> list[Callable[..., Any]]:
    ...
    # The generic http_request tool is offered as soon as any http integration
    ...
    if http_ids:
        from tools.integrations.http.request import build_http_request_tool
        tools.append(build_http_request_tool(http_ids))
