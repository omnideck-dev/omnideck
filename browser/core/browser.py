...
from browser.core.challenges import detect_challenge
from browser.core.downloads import DownloadInfo
...
class Browser:
    ...
    async def _handle_download(self, download: Any) -> None:
        ...
        try:
            ...
            from browser.core.downloads import build_download_info_from_path
