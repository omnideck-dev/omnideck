"""Detect anti-bot interstitial ("Verify you are human") pages.
...
interstitial; the caller then replaces the rendered document with the vendor's banner —
...
class ChallengeInfo(NamedTuple):
    ...
    Attributes:
        ...
        banner: Text to lead the rendered document with so the agent knows the page is
