...
/**
 * Keeps one user-opened Custom App mounted across desktop navigation until
...
export default function useCustomAppWorkspace({
    ...
    const openApps = useCallback(() => navigation.openApps(), [navigation]);
    ...
    const openPreview = useCallback((item) => {
        ...
        navigation.openWorkspace();
    }, [navigation, openPreviewFile, session]);
