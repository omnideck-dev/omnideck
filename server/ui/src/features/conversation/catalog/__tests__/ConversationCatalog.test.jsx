...
describe('ConversationCatalogProvider', () => {
    it('loads the list once on mount and never refetches it', async () => {
        render(<ConversationCatalogProvider><Probe /></ConversationCatalogProvider>);
