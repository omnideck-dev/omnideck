 ...
 * the latest screenshot — and, while `engaged`, turns the viewport into an input
...
export default function ScreencastViewport({
    frameUrl, fallbackSrc, engaged, active = true, sendInput, className,
    imgClassName, viewportRef: externalRef,
}) {
    ...
    // Always render the viewport element, even with no frame yet. Unmounting it
