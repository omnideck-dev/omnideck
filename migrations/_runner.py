...
from migrations._016_model_aware_role_defaults import migrate as _016_model_aware_role_defaults
...
_MIGRATIONS: list[tuple[str, Callable[[Path], None]]] = [
    ...
    ("016_model_aware_role_defaults", _016_model_aware_role_defaults),
]
