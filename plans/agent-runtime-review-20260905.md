...
[child setup](../agent_core/tools/_spawn_agent.py#L164),
...
Update agents/README.md and docs/agent_core_semantics.md along the way. They refer to removed paths and dispatcher concepts, describe obsolete browser-agent restrictions, and claim a hard iteration-limit behavior that the implementation does not enforce.
