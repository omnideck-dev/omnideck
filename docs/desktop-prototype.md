...
The first-run and repair experience follows the same product contract on every
supported operating system, even when platform requirements force the tasks to
...
The clickable reference for this contract is
[`desktop/tests/manual/setup-progress-mockup.html`](../desktop/tests/manual/setup-progress-mockup.html).
Its platform tabs document the accepted stage order and customer-facing states.
