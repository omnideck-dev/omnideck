...
| Tabbed content shell | `TabbedPane` | `components/TabbedPane.jsx` | `tabs`, `activeTab`, `onTabChange`, `onCloseTab`, `children`; the desktop dock composes Custom App and workspace preview tabs with it |
