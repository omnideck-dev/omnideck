...
def test_root_terminal_opens_beside_chat_without_stealing_chat(page: Page):
    ...
    expect(
        page.locator("[data-surface-resource-id='terminal']")
...
def test_closed_execution_view_stays_closed_until_a_new_conversation(page: Page):
    ...
    page.get_by_test_id("close-surface-tab-terminal").click()
    expect(page.get_by_test_id("surface-tab-terminal")).to_have_count(0)
