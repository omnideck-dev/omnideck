"""SDK scopes bind inputs; application sessions own run state and terminal events."""

import asyncio

import pytest

from sdk.control import ExecutionControl, get_execution_control
from sdk.context import ConversationHistory
from sdk.events import AgentEvent, ContentPayload, publish_event
from sdk.turn import StopRequestedError, check_stop, get_conversation_id, turn_scope
