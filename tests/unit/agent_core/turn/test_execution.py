"""Tests for the turn execution engine (agent_core.turn._execution).
...
import agent_core.turn._execution as _execution
...
from agent_core.turn._execution import ToolLoopError, AgentExecutor
...
def _patch_publish_event():
    ...
    The shared agent_core conftest already forwards published events into the
...
async def test_pre_set_external_stop_skips_provider_request() -> None:
    ...
    from agent_core.turn import turn_scope
...
async def test_stop_mid_stream_persists_partial_iteration(_patch_publish_event: MagicMock) -> None:
    ...
    from agent_core.turn import turn_scope
    from agent_core.control import get_execution_control
...
async def test_stop_after_final_delta_persists_full_answer(_patch_publish_event: MagicMock) -> None:
    ...
    from agent_core.hooks import StopHook
    from agent_core.turn import turn_scope
    from agent_core.control import get_execution_control
