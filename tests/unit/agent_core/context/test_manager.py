...
from agent_core.context import ContextManager, ConversationHistory, TriggerPoint
from agent_core.providers import ChatMessage, ChatResponse, TokenUsage
...
async def test_after_model_publishes_event():
    ...
    with patch("agent_core.context._manager.publish_event") as mock_pub:
...
async def test_context_hook_drives_after_model():
    from agent_core.hooks import ContextHook
    ...
    with patch("agent_core.context._manager.publish_event"):
