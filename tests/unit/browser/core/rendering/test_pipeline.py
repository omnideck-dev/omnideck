...
from browser.core.rendering.nodes import DomNode, NodeType, parse_nodes
from browser.core.rendering.pipeline import (
    _apply_budget,
    _filter_scope,
    _render_lines,
    _render_node,
...
def _interactive(role, name, *, ref=None, depth=0, value="", checked=None, expanded=None, selected=None, pressed=None):
    d = {
        "type": "interactive",
        "depth": depth,
        "role": role,
