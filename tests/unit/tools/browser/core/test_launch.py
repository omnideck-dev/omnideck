...
from tools.browser.core.launch import _ANTI_BOT_SCRIPT, _chrome_args, _launch_options
...
class TestChromeArgs:
    ...
    def test_uses_system_chrome_when_supported(self, monkeypatch: pytest.MonkeyPatch):
        monkeypatch.setattr("tools.browser.core.launch.platform.machine", lambda: "x86_64")
