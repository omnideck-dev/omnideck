...
from tools.browser.core.input._shared import _HumanConfig
from tools.browser.core.input.keyboard import human_press_keys, human_type
from tools.browser.core.input.pointer import (
    _bezier_point,
    _build_trajectory,
    _ease_in_out,
    human_click,
...
async def test_human_click_sequence_and_fallback(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "tools.browser.core.input._shared._config_cache",
        _HumanConfig(
